...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{theta2} \hlkwb{<-} \hlstd{coef[}\hlopt{-}\hlkwd{c}\hlstd{(}\hlnum{1}\hlopt{:}\hlnum{16}\hlstd{)]}
\hlstd{theta2}
\end{alltt}
\begin{verbatim}
##       V1:V2:V3       V1:V2:V4       V1:V3:V4       V2:V3:V4 
##        0.78438       -0.73438       -0.60313       -0.09063 
##       V1:V2:V5       V1:V3:V5       V2:V3:V5       V1:V4:V5 
##       -0.04687       -0.90312       -0.49062        0.05312 
##       V2:V4:V5       V3:V4:V5    V1:V2:V3:V4    V1:V2:V3:V5 
##        0.30312        0.74687        0.37813        0.81562 
##    V1:V2:V4:V5    V1:V3:V4:V5    V2:V3:V4:V5 V1:V2:V3:V4:V5 
##        0.14688       -0.55937       -0.89687        0.67187
\end{verbatim}
\begin{alltt}
\hlstd{r} \hlkwb{<-} \hlnum{2}
\hlstd{f} \hlkwb{<-} \hlnum{5}
\hlstd{SST} \hlkwb{<-} \hlstd{r}\hlopt{*}\hlnum{2}\hlopt{^}\hlstd{f}\hlopt{*}\hlkwd{as.vector}\hlstd{(}\hlkwd{t}\hlstd{(theta2)}\hlopt{%*%}\hlstd{theta2)}
\hlcom{## Degree of freedom of the numerator }
\hlstd{p2} \hlkwb{<-} \hlkwd{length}\hlstd{(theta2)}
\hlstd{p2}
\end{alltt}
\begin{verbatim}
## [1] 16
\end{verbatim}
\begin{alltt}
\hlcom{## Degree of freedom of the denominator}
\hlstd{p1} \hlkwb{<-} \hlnum{2}\hlopt{^}\hlstd{f}\hlopt{*}\hlstd{(r}\hlopt{-}\hlnum{1}\hlstd{)}
\hlstd{p1}
\end{alltt}
\begin{verbatim}
## [1] 32
...
\begin{alltt}
\hlcom{## F test value}
\hlstd{Ftest} \hlkwb{<-} \hlstd{(SST}\hlopt{/}\hlstd{p2)}\hlopt{/}\hlstd{sigma}\hlopt{^}\hlnum{2}
...
\end{verbatim}
\begin{alltt}
\hlcom{## pvalue of the test}
\hlnum{1} \hlopt{-} \hlkwd{pf}\hlstd{(Ftest, p2, p1)}
\end{alltt}
\begin{verbatim}
## [1] 0
\end{verbatim}
